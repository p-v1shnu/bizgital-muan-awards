...
const STARTING_JUDGING_STEPS = [
  ...
  {
    titleLo: 'ຄັດກອງ',
    bodyLo: 'ທີມງານກວດຄຸນສົມບັດ ແລະ ຜົນງານຕະຫຼອດປີ ແລ້ວສະຫຼຸບເປັນລາຍຊື່ຜູ້ເຂົ້າຊີງ',
  },
...
const STARTING_PAGE_SEO = {
  ...
  about: {
    titleLo: 'ກ່ຽວກັບງານ',
    descriptionLo: 'ທີ່ມາຂອງມ່ວນອາວອດສ໌, ເກນການຕັດສິນ ແລະ ຄຳຖາມທີ່ພົບເລື້ອຍ',
  },
  submit: {
    titleLo: 'ສົ່ງລາຍຊື່',
  ...
  winners: {
    ...
    descriptionLo: 'ຜູ້ຊະນະທຸກສາຂາ ທຸກປີ ຂອງມ່ວນອາວອດສ໌',
  },
};
