        ...
        >
          <FormSection id="home" title="ໜ້າຫຼັກ">
            <Card>
              ...
              <CardBody>
                ...
                <Field
                  ...
                  help="ຂໍ້ຄວາມຢູ່ກ້ອງຫົວຂໍ້ ຊື່ງານເທິງສຸດຂອງໜ້າຫຼັກ"
                >
                  <Textarea
                    required
            ...
            <Card className="xl:col-span-2">
              ...
              <CardBody>
                <Note>
                  ແນະນຳ 1200 × 900 px, ບໍ່ເກີນ 1.5MB ຕໍ່ຮູບ · ອັບໂຫລດໄດ້ສູງສຸດ 24 ຮູບ — ຮູບເລື່ອນອັດຕະໂນມັດ
                  ເທິງໃຊ້ພຽງ 8 ຮູບທຳອິດ (ຮູບອື່ນບໍ່ຂຶ້ນເລີຍ) ສ່ວນຄັງພາບລຸ່ມສຸດ ໜ້າຫຼັກໂຊວ໌ 6 ຮູບທຳອິດ
                  ຕາມລຳດັບທີ່ຈັດໄວ້ — ແຕ່ກົດເບິ່ງຮູບໃດໜຶ່ງແລ້ວກົດ “ຕໍ່ໄປ” ຈະເລື່ອນເບິ່ງໄດ້ຄົບທຸກຮູບທີ່ອັບໂຫລດໄວ້
                </Note>
                <div className="mt-3">
              ...
              <CardBody>
                ...
                <div className="mt-4">
                  <Field
                    ...
                    hint="— ບໍ່ບັງຄັບ"
                    help="ຂຶ້ນກ້ອງຫົວຂໍ້ “ວິດີໂອໄຮໄລທ໌” ເທິງໜ້າຫຼັກ — ຫົວຂໍ້ຄົງທີ່ ແຕ່ອັນນີ້ປ່ຽນໄດ້ທຸກຄັ້ງທີ່ປ່ຽນວິດີໂອ"
                  >
                    <Textarea
                      maxLength={300}
