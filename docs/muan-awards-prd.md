...
> **Mockup ที่ใช้ token ชุดนี้จริง:** `docs/design/design-kit.html` — เปิดดูสี ตัวอักษร และ layout ทุกหน้าได้ในไฟล์เดียว (self-contained ไม่ต้องต่อเน็ต)
...
1. ~~**Design** — ทำ wireframe/mockup หน้า public หลัก~~ **ทำแล้ว:** `docs/design/design-kit.html` — mockup หน้าแรก / หน้าปี / หน้าสาขา / ทำเนียบผู้ชนะ / ฟอร์ม ทั้ง desktop + mobile ใช้สีและฟอนต์จริง มี phase switcher ให้กดตรวจทั้ง 5 เฟสของหน้าปี (เปิดไฟล์ในเบราว์เซอร์ได้เลย ไม่ต้องติดตั้งอะไร)
