...
| | |
|---|---|
| **เวอร์ชัน** | 0.2 (Draft สำหรับรีวิว — ปรับทิศทางหน้าแรก/ดีไซน์) |
...
|---|---|---|---|
| 1 | **หน้าแรก (brand hub)** | `/` | ดีไซน์กลาง ไม่ผูกกับปี — Hero แนะนำแบรนด์ Muan Awards, ไฮไลต์ผู้ชนะปีล่าสุด (การ์ดสรุป ไม่ใช่รายละเอียดเต็ม), ตัวเลขสะสม (จำนวนปีที่จัด/สาขา/ครีเอเตอร์), แถบสถานะงานปีปัจจุบัน 1 จุด → ลิงก์ไปหน้าปี, ลิงก์ archive และ about |
| 2 | **หน้าปีการประกวด** | `/awards/[year]` (+ `/awards/latest` redirect ไปปี active ล่าสุด) | **เนื้อหาหลักของงานปีนั้นทั้งหมด** — key visual/อัตลักษณ์ของปี, ข้อมูลงาน (วันที่ สถานที่ กิจกรรม), สาขาทั้งหมดพร้อมนอมินี/ผู้ชนะ, section คณะกรรมการ — เนื้อหาปรับตามเฟส (ตารางข้อ 4) |
