...
8. **CTA ปิดท้าย** — ชวนส่งรายชื่อ
9. **Footer** — social, ติดต่อ, ลิงก์รวม
...
| 9 | เนื้อหาเว็บส่วนกลาง | `/admin/site` | แก้รูป hero หน้าแรก, ข้อความแบรนด์, ย่อหน้า about ย่อ, รูป collage — **เนื้อหา evergreen ที่ไม่ผูกกับปีใดปีหนึ่ง** |
...
erDiagram
    ...
    SiteSetting {
        ...
        json galleryImageKeys "nullable — รูป collage หน้าแรก 3–6 ใบ"
        datetime updatedAt
    }
